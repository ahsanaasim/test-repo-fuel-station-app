      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <div className="mb-6">
          <EditorialListHeader
            ...
            description="Track maintenance, utilities, and other costs against station revenue."
            badge={<span className="rounded-md bg-[var(--muted)] px-3 py-1 text-sm font-semibold">{formatCurrency(totalExpenses)}</span>}
            actions={
        ...
        {(showReady || showOffline) && (
          <div className="space-y-4">
            <EditorialSection
              eyebrow="Cost ledger"
              title="Add Expense"
              summary={`${formatCurrency(totalExpenses)} across ${expenseList.length} entries`}
              tone="warm"
              cta={
                <DialogTrigger asChild>
                  <Button size="lg">
            ...
            >
              <p className="text-sm text-[var(--muted-foreground)]">
                Capture category, amount, notes, and owner so accountant review stays close-ready.
              </p>
            </EditorialSection>
