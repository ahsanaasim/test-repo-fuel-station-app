  ...
  return (
    <AppShell navItems={managerNav} homeHref="/manager">
      <div className="mb-6 flex flex-wrap items-end justify-between gap-4">
        <div>
          <h1 className="font-heading text-3xl font-semibold">Reports & exports</h1>
          <p className="text-[var(--muted-foreground)]">
            Generate and download sales, inventory, and reconciliation summaries.
          </p>
        </div>
                    ...
                    >
                      ...
                      <CardContent>
                        ...
                        <p className="mt-1 text-xs text-[var(--muted-foreground)]">
                          {latest ? latest.period : "No reports yet"}
                        </p>
                      </CardContent>
                    </Card>
                  );
