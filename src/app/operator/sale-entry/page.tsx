    ...
    <AppShell navItems={operatorNav} homeHref="/operator">
      ...
      <div className="relative z-40 mx-auto flex min-h-[70vh] max-w-lg items-center justify-center px-2 py-8">
        ...
        {(showReady || showOffline) && (
          <Card className="w-full animate-float-in overflow-hidden shadow-[var(--shadow-soft)]">
            <div className="bg-[linear-gradient(135deg,#ff385c_0%,#e31c5f_100%)] px-6 py-8 text-white">
              ...
              <CardTitle className="mt-2 flex items-center gap-2 text-3xl text-white">
                <Fuel className="h-7 w-7" />
                Record fuel sale
              </CardTitle>
              <p className="mt-2 text-sm text-white/85">
                Fast editorial entry — confirm to add to today&apos;s board.
              </p>
            </div>
            <CardHeader className="sr-only">
              <CardTitle>Record fuel sale</CardTitle>
            </CardHeader>
