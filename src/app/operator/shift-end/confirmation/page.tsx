  ...
  return (
    <AppShell navItems={operatorNav} homeHref="/operator">
      ...
      {(showReady || showOffline) && (
        <div className="mx-auto max-w-2xl animate-float-in space-y-6">
          {showOffline && (
          ...
          <div className="text-center">
            ...
            <h1 className="font-heading mt-4 text-3xl font-semibold">Shift submitted</h1>
            <p className="mt-2 text-[var(--muted-foreground)]">
              {activeShift.operatorName}&apos;s shift is with the manager for verification.
            </p>
          </div>
