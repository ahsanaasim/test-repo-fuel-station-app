...
export const PRODUCT = {
  name: "Flowboard",
  tagline: "The editorial playbook for every fuel shift.",
  overview:
    "A magazine-style station board for operators, managers, accountants, and owners — sales, tanks, cash, and verification told as clear vertical chapters.",
};
